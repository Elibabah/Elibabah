import "./About.css"
import {SiHtml5, SiCss3, SiJavascript, SiReact, SiBootstrap, SiMaterialui, SiWebpack, SiBabel, SiChartdotjs, SiPlaycanvas, SiGnubash, SiGit, SiGithub, SiFirebase, SiJest, SiMarkdown, SiLinux, SiWindows, SiTailwindcss } from "react-icons/si";
...
function About() {
  ...
  return (
    ...
    <main className="description">Me</main>
